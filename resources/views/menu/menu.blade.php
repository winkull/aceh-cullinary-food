            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <!--begin::Page Title-->
                        <h2 class="text-dark font-weight-bold my-1 mr-5"><b>Menu Toko {{$data->nama}}</b></h2>
                        <!--end::Page Title-->
                    </div>
                    <!--end::Page Heading-->
                </div>
                    ...
                    <div class="col">
                        ...
                        <div class="card card-custom card-border">
                            <div class="card-header">
                                <h3 class="card-title">Data Menu Toko</h3>                                
                                <div class="card-toolbar">
                                    <a href="{{route('menu.create',['id' => $data->kode])}}" class="btn btn-sm btn-light-dark" role="button" aria-pressed="true">Tambah Menu</a>                                   
                                </div>
                            </div>
                            <!--begin::Body-->
                            <div class="card-body">
                                ...
                                <!--end: Datatable-->
                                <a href="{{route('tenant')}}" class="btn btn-sm btn-light-danger" role="button" aria-pressed="true">Kembali</a>
                            </div>
                            <!--end::Body-->
                        </div>
                        <!--end::Card-->
    ...
    <script>
        $(function () {
            ...
            table.DataTable({
                ...
                scrollCollapse: true,
                ajax:{
                    "url": "{{ route('menu.data',['id' => $data->kode]) }}",
                    "dataType": "json",
                    "type": "POST",
                    "data":{ _token: token},                    
                },
            ...
            $(document).on('click', '#Delete', function () {
                ...
                Swal.fire({
                    title: "Konfirmasi",
                    html: "Anda akan menghapus data Tenant <span class='text-danger'><strong>" + $(this).data('name') + "</strong></span>, lanjutkan ?",
                    icon: "warning",
