    ...
    <table class="table" cellpadding="0" cellspacing="0" style="align: center">
        ...
        @forelse ($reports as $report)                                            
            <tr>
                ...
                <td>{{ App\Helpers\MyHelper::date_id($report->tanggal) }}</td>
                <td>{{ $report->nama }}</td>
                ...
                <td>{{ $report->kupon }}</td>
                <td class="text-right">{{ number_format($report->nilai_kupon,0,',','.') }}</td>
                <td class="text-right">{{ number_format($report->ongkir,0,',','.') }}</td>
                <td class="text-right">{{ number_format($report->grandtotal,0,',','.') }}</td>
                <td>{{ $report->status_pesanan }}</td>
                <td>{{ App\Helpers\MyHelper::date_id($report->tanggal_status) }}</td>
                <td>{{ $report->status_bayar }}</td>
            </tr>                                            
        @empty
            <tr>
                <td colspan="16"><center>Data Belum Tersedia</center></td>
            </tr>
        @endforelse
    </table>
</main>
