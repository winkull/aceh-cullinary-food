                ...
                <div class="col col-lg">
                    ...
                    <div class="card card-custom card-border">
                        <div class="card-header ribbon ribbon-top">
                            <div class="ribbon-target bg-dark" style="top: -2px; right: 20px;">Form Pameran</div>
                        ...
                        <!--begin::Form-->
                        <form method="POST" action="{{ route('pameran.add') }}" class="form" id="tenant-form" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col col-lg-6">
                                        <div class="form-group">
                                            <label>Judul</label>
                                            <input type="text" name="judul" class="form-control form-control-solid" value="{{ old('judul') }}" placeholder="Masukkan Judul Pemeran" required />
                                        </div>
                                        <div class="form-group">
                                            <label>Link Url</label>
                                            <input type="text" name="linkurl" class="form-control form-control-solid" value="{{ old('linkurl') }}" placeholder="Masukkan Link Url" required />
                                        </div>
                                        <div class="form-group">
                                            <label>Status</label>
