                        ...
                        <div class="card card-custom card-border">
                            <div class="card-header ribbon ribbon-top">
                                <div class="card-title align-items-start flex-column" style="margin-top: 15px;">
                                    <h3 class="card-label font-weight-bolder text-dark">Daftar Link Youtube</h3>
                                    <span class="text-muted font-weight-bold font-size-sm mt-1">Menampilkan semua data link youtube yang akan diputar di Panggung pameran.</span>
                                </div>
                                <div class="card-toolbar">
                                    <a href="{{route('pameran.create')}}" class="btn btn-light-dark" role="button" aria-pressed="true">Tambah Pameran</a>                                   
                                </div>
                            </div>
                            <!--begin::Body-->
                            <div class="card-body">
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '#Delete', function () {
                ...
                Swal.fire({
                    title: "Konfirmasi",
                    html: "Anda akan menghapus data pameran<span class='text-danger'><strong>" + $(this).data('name') + "</strong></span>, lanjutkan ?",
                    icon: "warning",
