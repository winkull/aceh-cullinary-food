                ...
                <div class="col col-lg">
                    ...
                    <div class="card card-custom card-border">
                        <div class="card-header ribbon ribbon-top">
                            <div class="ribbon-target bg-dark" style="top: -2px; right: 20px;">Form Promo Umum</div>
                            <div class="card-title align-items-start flex-column" style="margin-top: 15px;">
                                <h3 class="card-label font-weight-bolder text-dark">Daftar Kode Promosi</h3>
                                <span class="text-muted font-weight-bold font-size-sm mt-1">Masukkan data sesuai dengan kolom yang tersedia.</span>
                            </div>
                        </div>
                        <!--begin::Form-->
                        <form method="POST" action="{{ route('promo.add') }}" class="form" id="tenant-form" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label>Upload Foto Promo</label>
                                            <div class="card card-custom card-border overlay" id="picture-overlay">
                                                <div class="card-body ribbon ribbon-top p-0">
                                                    <div class="ribbon-target bg-light-dark" style="top: -2px; right: 20px;">Foto Promo</div>
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '#cancel-btn', function () {
                window.location.href = '{{ route('promo') }}';
            });
        });
    </script>
@endsection
