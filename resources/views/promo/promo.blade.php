                        ...
                        <div class="card card-custom card-border">
                            <div class="card-header ribbon ribbon-top">
                                <div class="card-title align-items-start flex-column" style="margin-top: 15px;">
                                    <h3 class="card-label font-weight-bolder text-dark">Daftar Promosi</h3>
                                    <span class="text-muted font-weight-bold font-size-sm mt-1">Menampilkan semua kode promosi yang berlangsung pada acara ini.</span>
                                </div>
                                <div class="card-toolbar">
                                    <a href="{{route('promo.create')}}" class="btn btn-light-dark" role="button" aria-pressed="true">Tambah Promo</a>                                   
                                </div>
                            </div>
                            <!--begin::Body-->
                            <div class="card-body">
