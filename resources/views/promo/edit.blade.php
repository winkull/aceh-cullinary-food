                ...
                <div class="col col-lg">
                    ...
                    <div class="card card-custom card-border">
                        <div class="card-header ribbon ribbon-top">
                            <div class="ribbon-target bg-dark" style="top: -2px; right: 20px;">Form Edit Promo Umum</div>
                        ...
                        <!--begin::Form-->
                        <form method="POST" action="{{ route('promo.update',['id' => $datas->id]) }}" class="form" id="tenant-form" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                            ...
                                            <div class="card card-custom card-border overlay" id="picture-overlay">
                                                <div class="card-body ribbon ribbon-top p-0">
                                                    ...
                                                    <div class="overlay-wrapper">                          
                                                        <img id="blah" src="{{ asset('uploads/promo/'.$datas->gambar) }}" alt="image store" width="100%" />
