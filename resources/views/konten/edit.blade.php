            ...
            <div class="container-fluid">
                <div class="col col-lg">
                    ...
                    <div class="card card-custom card-border">
                        ...
                        <!--begin::Form-->
                        <form method="POST" action="{{ route('konten.update',['id' => $datas->id]) }}" class="form" id="tenant-form" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col col-lg-6">
                                        <div class="form-group">
                                            <label>Uraian</label>
                                            <input type="text" name="uraian" class="form-control form-control-solid" value="{{ $datas->uraian }}" placeholder="Masukkan Uraian" required />
                                        </div>
                                        <div class="form-group">
                                            <label>Tautan</label>
                                            <input type="text" name="tautan" class="form-control form-control-solid" value="{{ $datas->tautan }}" placeholder="Masukkan Tautan" required />
                                        </div>                                  
                                    </div>
                                    <div class="col col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="card card-custom card-border overlay" id="picture-overlay">
                                                <div class="card-body ribbon ribbon-top p-0">
                                                    ...
                                                    <div class="overlay-wrapper">                          
                                                        <img id="blah" src="{{ asset('uploads/konten/'.$datas->gambar) }}" alt="image store" width="100%" />
