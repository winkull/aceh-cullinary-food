                        ...
                        <div class="card card-custom card-border">
                            <div class="card-header ribbon ribbon-top">
                                <div class="card-title align-items-start flex-column" style="margin-top: 15px;">
                                    ...
                                    <span class="text-muted font-weight-bold font-size-sm mt-1">Menampilkan data Quiz</span>
                                </div>
                                <div class="card-toolbar">
                                    <a href="{{route('quiz.create')}}" class="btn btn-light-dark" role="button" aria-pressed="true">Tambah Quiz</a>                                   
                                </div>
                            </div>
                            <!--begin::Body-->
                            <div class="card-body">
